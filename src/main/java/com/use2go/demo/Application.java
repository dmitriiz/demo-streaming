...
import com.use2go.demo.service.impl.DataProcessorImpl;
...
public class Application {
    ...
    protected class KafkaConfig {
        ...
        @Bean
        public KStream<String, DataMessage> processingStream(StreamsBuilder builder, EsperService esperService, DataProcessor processor) {
            EPRuntime runtime = esperService.createRuntime(new ClassPathResource("demo.txt"), DataMessage.class, processor::handle);
